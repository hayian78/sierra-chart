...
## Operational Use
* **Visual Cues:** A HUD table displaying nearest levels, and/or horizontal lines on the chart. **New Update:** Levels clustered closely together will automatically merge or stagger their text labels, ensuring readability on compressed charts.
